...
<!DOCTYPE html>
   ...
   ?> -->
  <?php include'../admin/post_property.php';
  ?>
   ...
   if(isset($_POST['delete'])){
      ...
      if($verify_delete->rowCount() > 0){
         ...
         while($fetch_images = $select_images->fetch(PDO::FETCH_ASSOC)){
            ...
            unlink('../admin/uploaded_files/'.$image_01);
            if(!empty($image_02)){
               unlink('..admin/uploaded_files/'.$image_02);
            }
            if(!empty($image_03)){
   ...
   <section class="listings">
      ...
      <?php
         ...
         if($select_listings->rowCount() > 0){
            ...
            $select_user->execute([$fetch_listing['admin_id']]);
      ...
      <div class="box">
         <div class="thumb">
            ...
            <img src="../admin/uploaded_files/<?= $fetch_listing['image_01']; ?>" alt="">
         </div>
