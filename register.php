...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="pass" required maxlength="10" placeholder="Enter your password *" class="box">
      <input type="password" name="c_pass" required maxlength="10" placeholder="Confirm your password *" class="box">
